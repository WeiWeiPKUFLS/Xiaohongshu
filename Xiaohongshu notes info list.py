...
directory = '/Users/weiwei/Documents/Atian/Photo-text notes 14Mar23'

# create an empty dataframe to store the results
df = pd.DataFrame(columns=['note_type', 'title', 'liked_count', 'collected_count', 'comments_count', 'thumb', 'webpage_url', 'time', 'last_update_time'])
...
df.to_csv('/Users/weiwei/Documents/Atian/Photo-text notes 14Mar23/output.csv', encoding='utf-8-sig', index=False)
